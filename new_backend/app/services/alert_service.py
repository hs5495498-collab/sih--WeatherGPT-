class AlertService:
    ...
    def create_alert(
        ...
        return {
            ...
            # See AlertItem/AlertsResponse in schemas/alert.py: every alert this
            # locally-generated engine produces is an automated advisory, never
            # an official government warning.
            "information_class": "AUTOMATED_ADVISORY"
        }
